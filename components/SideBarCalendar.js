        ...
        <>
            <div className="lg:w-1/5 w-full relative text-white">
                ...
                <ul className="flex lg:flex-col flex-row">
                    ...
                    <li className="bg-opacity-50 bg-black text-yellow-300 w-8 h-8 rounded-full flex lg:flex-col flex-row items-center justify-center border-yellow-300 border-2 text-sm font-bold font-mono">
                        15
                    </li>
                    <li className="w-8 h-10 flex lg:flex-col flex-row items-center justify-center text-xs">16</li>
