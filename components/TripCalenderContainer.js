    ...
    return (
        <>
            <div className="lg:w-4/5 w-full">
                <div className="lg:w-1/3 w-full relative lg:ml-64 ml-auto lg:pt-48 pt-8">
                    <div className="flex">
                        <div className="w-1/4">
                        ...
                        <div className="text-center border border-white w-full ml-3">
                            <h2 className="text-white head-t font-bold px-1 font-mono tracking-wide">
                                HILTON HOTEL
                            </h2>
                            <div className="bg-white py-1 text-sm">POWERED BY TRAVEL JINNI</div>
                        </div>
                    </div>
                    <div className="mt-2 border border-white bg-gray-400 bg-opacity-10 blur-filter rounded-md">
                        <div className="text-center p-4">
                            <h3 className="text-center lg:text-5xl text-2xl font-serif font-semibold py-5 text-white leading-normal">
